    ...
    case .jwk(
      ...
      case .msoMdoc(let spec):
        ...
        let header = try JWSHeader(parameters: [
          ...
          let confIssuer = Bundle.main.object(forInfoDictionaryKey: "Vci Client Id") as? String
//          let confIssuer = getBundleValue(key: "Vci Client Id");
        
        let dictionary: [String: Any] = [
          JWTClaimNames.issuedAt: Int(Date().timeIntervalSince1970.rounded()),
          JWTClaimNames.audience: aud,
          JWTClaimNames.nonce: cNonce ?? "",
          JWTClaimNames.issuer: issuer ?? confIssuer ?? "",
        ]
